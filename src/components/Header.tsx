    ...
    <header className="bg-[#FAF8F5] shadow-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          {/* Main menu */}
          <ul className={`flex-col md:flex-row md:flex md:space-x-8 text-sm md:text-base font-medium text-center ${isOpen ? 'flex' : 'hidden'} md:flex`}>
            <li><a href="#" className="block py-2 px-4 text-[#4B715F] hover:text-[#416353]">Accueil</a></li>

            {/* Dropdown 1 */}
            <li className="relative">
              <button onClick={() => toggleDropdown('beaute')} className="block py-2 px-4 text-[#4B715F] hover:text-[#416353] w-full text-left md:text-center">
                Beauté
              </button>
              {activeDropdown === 'beaute' && (
                <ul className="absolute md:absolute bg-[#E2D6CF] mt-1 rounded shadow-lg z-10 left-0 w-40 text-left">
                  <li><a href="#" className="block px-4 py-2 hover:bg-[#d2c5bf]">Maquillage</a></li>
                  <li><a href="#" className="block px-4 py-2 hover:bg-[#d2c5bf]">Soins du visage</a></li>
                </ul>
              )}
            </li>
            ...
            {/* Dropdown 2 */}
            <li className="relative">
              <button onClick={() => toggleDropdown('nutrition')} className="block py-2 px-4 text-[#4B715F] hover:text-[#416353] w-full text-left md:text-center">
                Nutrition
              </button>
              {activeDropdown === 'nutrition' && (
                <ul className="absolute md:absolute bg-[#E2D6CF] mt-1 rounded shadow-lg z-10 left-0 w-40 text-left">
                  <li><a href="#" className="block px-4 py-2 hover:bg-[#d2c5bf]">Recettes</a></li>
                  <li><a href="#" className="block px-4 py-2 hover:bg-[#d2c5bf]">Conseils santé</a></li>
                </ul>
              )}
            </li>

            <li><a href="#" className="block py-2 px-4 text-[#4B715F] hover:text-[#416353]">Soins</a></li>
            <li><a href="#" className="block py-2 px-4 text-[#4B715F] hover:text-[#416353]">Contact</a></li>
          </ul>
        </div>
      </div>
    </nav>
